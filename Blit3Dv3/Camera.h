...
#include <random>
extern std::uniform_real_distribution<float> angle_dist(0, M_PI * 2); //360 degrees
extern std::uniform_real_distribution<float> angle_variance_dist(-M_PI / 6.0, M_PI/6.0); //+-30 degrees
